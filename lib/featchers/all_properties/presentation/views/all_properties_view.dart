...
import '../manager/all_properties_cubit/all_properties_cubit.dart';
...
class AllPropertiesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AllPropertiesCubit, AllPropertiesState>(
              ...
              Expanded(
                child: Padding(
                  ...
                  child: PropertiesListView(
                      editable: false,
                      properties: BlocProvider.of<AllPropertiesCubit>(context)
                          .response),
                ),
              ),
            ],
